...
const StyledTextGradient = styled(m.h1)(({ theme }) => ({
  ...textGradient(
    `300deg, ${theme.palette.primary.main} 0%, ${theme.vars.palette.secondary.main} 25%, ${theme.palette.primary.main} 50%, ${theme.vars.palette.secondary.main} 75%, ${theme.palette.primary.main} 100%`
  ),
  padding: 0,
  marginTop: 8,
  lineHeight: 1,
...
export function HomeHero() {
  ...
  const renderDescription = (
    ...
    >
      ...
      <m.div variants={varFade('in')}>
        <Stack spacing={1.5} direction={{ xs: 'column-reverse', sm: 'row' }} sx={{ mb: 5, mt: 3 }}>
          <Stack
            alignItems="center"
            spacing={3}
